// Copied from: https://github.com/DannMolina/country-list-json/blob/master/index.js
// Project:     https://github.com/DannMolina/country-list-json
// License:     ISC (a permissive license)
